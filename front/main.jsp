    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top"> ---------------- <img alt="" src="/front/assets/img/logo.png"> </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <img alt="" src="/front/assets/img/logo.png">
                </div>
            </div>
        </nav>
        <!-- Masthead-->
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        ...
                        <a class="btn btn-primary btn-xl" href="#about">핸드폰 인증하고 거래하기</a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">천둥거래입니다!</h2>
                        ...
                        <a class="btn btn-light btn-xl" href="#services">주변 물품 찾기</a>
                    </div>
                </div>
            </div>
        </section>
